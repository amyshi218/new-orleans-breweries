...
This app uses Google Map React. You would need to get a google api key first before running the app. Go to [Google Maps Platform](https://mapsplatform.google.com/) and get a google api key. Make sure Geocoding API and Maps JavaScript API is enabled. Once you've obtained a key, create a config.js file in the same format as the configexample.js and insert your google api key where it says 'GOOGLE API KEY' in quotes.
````
